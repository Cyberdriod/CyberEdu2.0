package cyberdroid.jobportal.services;
...
public class Mailclass {
	...
	public static void sendemail(String toemailid, String messagepart, String sub) throws IOException {
		...
		String mess = messagepart
				+ "<br><br> Please make sure to check your junk/spam folder for a mail from inquiry@xyz.com for the same.<br><br>"
				...
				+ " <b>Thank You,</b> <br>" + " <b>xyz Consultant </b> </p><br><br><hr>"
