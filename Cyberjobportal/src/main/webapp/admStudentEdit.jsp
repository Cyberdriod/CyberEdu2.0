					...
					<div class="tab-content">
						<div class="tab-pane active">
							...
							<sql:query dataSource="${webappDataSource}" var="result">
						          select * from cyberedudb.studregistration where userid=<%=userid%>;
				          		</sql:query>
										...
										<div class="row col-md-12">
											...
											<div class="col-md-4">
												<label>Last name:</label> <input type="text"
													class="form-control" value="${row.lastname}"
													name="lastname"> <br>
											</div>

											<div class="col-md-8">
												<label>Address:</label> <input type="text"
													class="form-control" value="${row.address}" name="address">
											</div>
											<div class="col-md-4">
										...
										<div class="row col-md-12">
											...
											<div class="col-md-4">
												...
												<div class="input-group">
													...
													<input type="text" class="form-control"
														value="${row.primarymobileno}" name="primarymobileno"
											...
											<div class="col-md-4">
												...
												<div class="input-group">
													...
													<input type="text" class="form-control"
														value="${row.secondarymobileno}" name="secondarymobileno"
														data-inputmask='"mask": "(999) 999-9999"' data-mask>
												</div>
											</div>
									...
									<div class="box-body">
										<div class="form-group">
											<form action="admeducation" method="post">
												<div class="row col-md-12">
													<sql:query dataSource="${webappDataSource}" var="result">
						          select * from cyberedudb.studeducational where eduid=<%=userid%>;
				          		</sql:query>
														...
														<div class="col-md-3">
															...
															<div class="form-group has-feedback">
																<input type="text" value="${row.university}"
																	class="form-control" name="university"> <input
																	type="hidden" value="${row.eduid}" name="eduid">
															</div>
														</div>
									...
									<div class="box-body">
										...
										<form action="edudelete.htm" method="post">
											<sql:query dataSource="${webappDataSource}" var="result">
						          select * from cyberedudb.studeducational where userid=<%=userid%>;
				          		</sql:query>
							...
							<section class="content">
								<div class="box box-default">
						          ...
						          select * from studexperience where expid=<%=userid%>;
				          		</sql:query>
												<c:forEach begin="0" end="0" var="row"
													items="${result2.rows}">
													<div class="row col-md-12">
														...
														<div class="col-md-4">
															...
															<label>Job Title</label> <input type="text"
																class="form-control" value="${row.jobtitle}"
																name="jobtitle">
														...
														<div class="col-md-4">
															<label>Company Name</label> <input type="text"
																class="form-control" value="${row.companyname}"
																name="companyname">
														...
														<div class="col-md-4">
															<label>Company Domain</label> <input type="text"
																class="form-control" value="${row.companydomain}"
																name="companydomain">
											...
											<form action="expdelete.htm" method="post">
												<sql:query dataSource="${webappDataSource}" var="result1">
						          select * from cyberedudb.studexperience where userid=<%=userid%> ;
				          		</sql:query>
												<div class="box-body">
													<div class="box-header"></div>
													<table id="example"
									...
									<div class="box-body">
										<div class="form-group">
											<form action="Project1" method="post">
												<sql:query dataSource="${webappDataSource}" var="result2">
						          select * from cyberedudb.studproject where proid=<%=userid%>;
				          		</sql:query>
													...
													<div class="row col-md-12">
														...
														<div class="col-md-6">
															<label>Role</label> <input type="text"
																class="form-control" placeholder="${row2.role}"
																name="role">
														</div>
														<div class="col-md-6">
															<label>Technology Used</label> <select
														...
														<div class="col-md-4">
															<div class="form-group">
																...
																<div class="input-group date">
																	...
																	<input type="date" class="form-control pull-right"
																		value="${row2.ptime}" name="ptime"> <input
																		type="hidden" value="${row2.proid}" name="proid">
																</div>
																<!-- /.input group -->
