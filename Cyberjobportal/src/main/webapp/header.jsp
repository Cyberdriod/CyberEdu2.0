					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								alt="User Image"> <span class="hidden-xs"><%=useremailheader%></span>
						</a>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="stuProfile.jsp"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a href="stuProfile.jsp"><i
									class="fa fa-mortar-board "></i> Educational</a></li>
							<li><a href="sstuProfile.jsp"><i
									class="fa fa-paper-plane-o"></i> Exprience</a></li>
							<li><a href="stuProfile.jsp"><i class="fa  fa-book "></i>
									Cources</a></li>
							<li><a href="stuProfile.jsp"><i
							...
							<li><a href="stuProfile.jsp"><i
									class="fa  fa-university"></i> Resume</a></li>
						</ul></li>
					<li class="treeview"><a href="stuJob.jsp"> <i
						...
						<ul class="treeview-menu">
							<li><a href="stuJob.jsp"><i class="fa fa-circle-o"></i>
									Listed jobs</a></li>
							<li><a href="stuJob.jsp"><i class="fa fa-circle-o"></i>
									Applied Job</a></li>
							<li><a href="stuJob.jsp"><i class="fa fa-circle-o"></i>
					...
					<li class="treeview"><a href="#"> <i
							class="fa  fa-envelope"></i> <span>Messages</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="pages/UI/general.html"> <i
									class="fa fa-circle-o"></i> Admin
							</a></li>
							<li><a href="pages/UI/icons.html"> <i
									class="fa fa-circle-o"></i> Listed jobs
							</a></li>
							<li><a href="pages/UI/buttons.html"> <i
									class="fa fa-circle-o"></i> Company Messages
							</a></li>
						</ul></li>
				</ul>
			</section>
