						...
						<div class="tab-pane active">
							...
							<section class="content">
								<div class="box box-default">
									...
									<form action="postjob.htm" method="post">
											...
											<div class="form-group">
												<div class="col-md-6 ">
													...
													<div class="form-group has-feedback">
														<label>Job Title:</label><input type="text"
															class="form-control" name="jtitle">
													</div>
												</div>
												...
												<div class="row col-md-12">
													...
													<div class="col-md-4">
														...
														<div class="form-group has-feedback">
															<input type="text" class="form-control" name="vaccancies">
														</div>
													</div>
												</div>
												...
												<div class="row col-md-12">
													<div class="col-md-6">
														...
														<div class="form-group has-feedback">
															<textarea class="form-control" rows="5"
																placeholder="Enter ..." name="jdesc"></textarea>
														</div>
													</div>
													...
													<div class="col-md-6">
														...
														<div class="form-group has-feedback">
															<textarea class="form-control" rows="5"
																placeholder="Enter ..." name="hprocess"></textarea>
														</div>
													</div>
												</div>
												...
												<div class="row col-md-12">
													...
													<div class="col-md-4">
														<label>Job Location</label> <select
															class="form-control select2" name="jlocation">
												...
												<div class="row col-md-12">
													<div class="col-md-6">
														...
														<div class="form-group has-feedback">
															<textarea class="form-control" rows="5"
																placeholder="Enter ..." name="ndocument"></textarea>
														</div>
													</div>
