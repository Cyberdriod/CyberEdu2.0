					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="tab_1">
							...
							<sql:query dataSource="${webappDataSource}" var="result1">
						          select * from cyberedudb.studregistration where userid=<%=useridheder%>;
				          		</sql:query>
												...
												<div class="col-md-3">
													...
													<div class="input-group">
														<span class="input-group-btn">
															...
															autocomplete="off" value="${row1.firstname}" name="fname">
														<span id="firsterror" class="text-danger text-weight-bold"></span>
													</div>
												</div>
												<div class="col-md-3">
													<label>Middle name:</label> <input type="text"
														class="form-control" value="${row1.middlename}"
														id="middlename" autocomplete="off" name="mname"> <span
														id="middleerror" class="text-danger text-weight-bold"></span>
												</div>
												<div class="col-md-3">
												...
												<div class="col-md-4">
													...
													<div class="input-group">
														...
														<input type="text" class="form-control"
															value="${row1.primarymobileno}" name="pmobile">
													</div>
												</div>
												<div class="col-md-4">
													...
													<div class="input-group">
														...
														<input type="text" class="form-control"
															value="${row1.secondarymobileno}" name="smobile">
