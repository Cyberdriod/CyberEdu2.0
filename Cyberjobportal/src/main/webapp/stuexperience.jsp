							...
							<div class="box box-default">
								<div class="box-body">
									<div class="form-group">
										<!--open- col-md-12 -->
										<form action="Experience.htm" method="post">
											...
											<div class="row col-md-12">
												<div class="col-md-4">
													<label>Job Title</label> <input type="text"
														class="form-control" placeholder="Job Title" name="jobtitle">
												</div>
												<div class="col-md-4">
												...
												<div class="col-md-4">
													<label>Company Domain</label> <input type="text"
														class="form-control" placeholder="companydomain"
														name="cdomain">
												</div>
