							...
							<div class="box box-default">
								<div class="box-body">
									<div class="form-group">
										<!--open- col-md-12 -->
										<form action="project.htm" method="post">
											<input type="hidden" value="<%=useridheder%>" name="userid">
											<div class="row col-md-12">
												<div class="col-md-6">
													<label>Project Title</label> <input type="text"
														class="form-control" placeholder="Job Title" name="projecttitle">
												</div>
												...
												<div class="form-group">
													...
													<div class="input-group date">
														...
														<input type="date" class="form-control pull-right"
															id="datepicker" name="projectdate">
													</div>
													<!-- /.input group -->
											...
											<div class="col-md-8">
												...
												<textarea class="form-control" rows="2" name="projectdesc"></textarea>
												<br>
											...
											<form action="prodelete.htm" method="post">
											<sql:query dataSource="${webappDataSource}" var="result2">
						          select * from studproject where userid=<%=useridheder%>;
				          		</sql:query>
