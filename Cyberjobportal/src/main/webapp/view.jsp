													...
													<c:forEach var="row1" begin="0" end="0"
														...
														<div class="row col-md-12">
															...
															<div class="col-md-4">
																...
																<div class="form-group has-feedback">
																	<input type="text" class="form-control"
																		value="${row1.vaccancies }" name="vaccancies"
																		readonly="readonly">
																</div>
															</div>
														</div>
														...
														<div class="row col-md-12">
															<div class="col-md-6">
																...
																<div class="form-group has-feedback">
																	<textarea class="form-control" rows="5"
																		placeholder="${row1.jdesc }" name="jdesc"
															...
															<div class="col-md-6">
																...
																<div class="form-group has-feedback">
																	<textarea class="form-control" rows="5"
																		placeholder="${row1.hprocess }" name="hprocess"
																		readonly="readonly"></textarea>
																</div>
															</div>
														</div>
																...
																<div class="form-group">
																	...
																	<div class="input-group">
																		...
																		<input type="date" class="form-control pull-right"
																			...
																			name=" dtapply" readonly="readonly">
																	</div>
																	<!-- /.input group -->
																</div>
															</div>
														...
														<div class="row col-md-12">
															<div class="col-md-6">
																...
																<div class="form-group has-feedback">
																	<textarea class="form-control" rows="5"
																		placeholder="${row1.ndocument }" name="ndocument"
																		readonly="readonly"></textarea>
																</div>
															</div>
